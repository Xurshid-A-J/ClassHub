...
namespace Intrastructure.Migrations
{
    ...
    [Migration("20230601172418_UpdateDatabase")]
            ...
            modelBuilder.Entity("Domain.Entities.Students.Student", b =>
                {
                    ...
                    b.HasOne("Domain.Common.UserEntity", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Students.Student", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Teachers.Teacher", b =>
                {
                    ...
                    b.HasOne("Domain.Common.UserEntity", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Teachers.Teacher", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
